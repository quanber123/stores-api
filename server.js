...
import { router_page_dashboard } from './router/dashboard/page.router.js';
import { router_notifications } from './router/users/notifications.router.js';
import { router_page } from './router/users/page.router.js';
import { router_about_dashboard } from './router/dashboard/about.router.js';
import { router_currency_dashboard } from './router/dashboard/currency.router.js';
config();
connectDb();
connectRedis();
const app = express();
...
//     console.error('Error seeding data:', error.message);
//   });
setCampaign('1 0 * * *', checkAndUpdateCoupon);
app.use(passport.initialize());
app.use(passport.session());
app.use(router_page_dashboard);
app.use(router_seo);
...
app.use(router_currency_dashboard);
app.use(router_store_dashboard);
app.use(router_tag_dashboard);
app.use(router_about_dashboard);
