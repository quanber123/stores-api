...
import { getProductByIdCallBack } from '../product/product.controllers.js';
export const getAllBlogsCallback = async (req, res) => {
...
export const getBlogByIdCallback = async (req, res) => {
  const { id } = req.params;
  try {
